    ...
    >
      <nav className="max-w-[1100px] mx-auto px-6 sm:px-8 py-5 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden md:inline-flex items-center bg-accent text-bg font-display font-bold text-xs tracking-widest px-5 py-2.5 hover:opacity-85 transition-opacity"
        >
          Hire Me →
        </a>
